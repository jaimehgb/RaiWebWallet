...
There's a development environment set up using <a href="https://docs.docker.com/engine/installation/" target="_blank">Docker</a>.

To get started, simply run the following to start the Docker containers:

<pre>
docker-compose up
</pre>

The server is now available at <a href="http://127.0.0.1:8080/" target="_blank">http://127.0.0.1:8080/</a>.
...
<h3>TODO</h3>
<hr/>
 - <del>Find an efficient way to generate PoW at the browser.</del><br/>
